...
The poc-rest-owl-loop workflow has 7 phases. Each phase produces artifacts that feed the next. **Never skip phases** — the quality of the final product depends on thorough upfront work.
...
All poc-rest-owl-loop artifacts live under `docs/rest-owl/` in the project root:
