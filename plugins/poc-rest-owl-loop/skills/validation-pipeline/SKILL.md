...
description: >
  ...
  Used as Phase 6 of the poc-rest-owl-loop workflow.
...
- As Phase 6 of the poc-rest-owl-loop workflow
...
The examples below default to **Bun** as the runtime and **Playwright** for E2E testing. These are defaults — adapt to whatever the user chose in Phase 0 and Phase 4 (architecture). The `testRunner` and `e2eFramework` settings in `poc-rest-owl-loop.settings.yaml` also control defaults. The patterns and principles apply regardless of specific tool choices.
