# ⚠️  VENDORED FROM shared/lib/safe-settings-write.sh
# Do not edit this file directly — modify shared/lib/safe-settings-write.sh and run scripts/sync-shared-lib.sh
# See https://github.com/nsheaps/ai-mktpl/issues/474 + https://github.com/anthropics/claude-code/issues/53948 for context
#!/usr/bin/env bash
