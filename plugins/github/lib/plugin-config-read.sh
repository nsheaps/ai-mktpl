# ⚠️  VENDORED FROM shared/lib/plugin-config-read.sh
# Do not edit this file directly — modify shared/lib/plugin-config-read.sh and run scripts/sync-shared-lib.sh
