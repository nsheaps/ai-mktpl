...
| Difference                                                                                                 | Status                                                                                 |
| ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| "At a glance" is composed deterministically here; the built-in uses an LLM prompt                          | Prompt (`Zqb`) is extractable — [#733](https://github.com/nsheaps/ai-mktpl/issues/733) |
| Team-feedback block is rendered here; the built-in suppresses it                                           | Addition, not a reproduction                                                           |
| Facet labels humanized generically (`_` → space) vs a per-key Title-Case map                               | Map (`Nqb`) is extractable — [#733](https://github.com/nsheaps/ai-mktpl/issues/733)    |
