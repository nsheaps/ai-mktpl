...
skill: scan your local session transcripts for how you've used Claude Code in
this repo over a recent window, classify your work into task types using the
built-in's verbatim prompt, and co-author an `ONBOARDING.md` guide that
teammates can paste into Claude Code for a guided setup tour.
