...
This is a lightweight template for plugin/PR-scoped specs (the kind
`agentic-behavior:spec-management` covers). For full software-product specs,
see the more comprehensive template at
`plugins/sdlc-utils/skills/spec-writing/references/spec-template.md`.
