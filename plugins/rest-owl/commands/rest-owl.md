...
You have been given a project idea. Your job is to turn this simple idea into a complete, production-quality software project using the rest-owl workflow.
