...
Always make sure to document your implementation decisions and create clear, maintainable code that follows project conventions. Write it in a style so a junior developer can continue your work at any time.
